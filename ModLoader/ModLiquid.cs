...
namespace ModLiquidLib.ModLoader
{
	...
	public abstract class ModLiquid : ModTexturedType, ILocalizedModType, IModType
	{
		...
		/// <returns></returns>
		public virtual bool ProjectileLiquidMovement(Projectile proj, ref Vector2 wetVelocity, Vector2 collisionPosition, int Width, int Height, bool fallThrough, bool ignoreDoors)
		{
			return true;
		}
